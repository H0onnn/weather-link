...
type WeeklyWeatherCondition = {
  skyAndPre: SkyConditionEnum | PrecipitationTypeEnum; // 하늘 및 강수
  rnst: string; // 강수 확률 %
};
 ...
 * 주간 예보 (온도)
 */
export type WeeklyTemperature = {
  location: string;
  forecasts: WeeklyTemperatureForecasts[];
};

type WeeklyTemperatureForecasts = {
  forecastDate: string; // 예보 날짜 ex) YYYYMMDD
